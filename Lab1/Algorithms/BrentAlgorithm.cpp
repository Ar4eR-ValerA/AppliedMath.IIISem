...
double BrentAlgorithm::GetMin(const IFunc& func, double leftBound, double rightBound, double eps) {
...
double BrentAlgorithm::ParabolaMin(const IFunc& func, double leftPoint, double innerPoint, double rightPoint) {
